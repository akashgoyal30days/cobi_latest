...
class receivedenquiriesdetailsviewscreen extends StatefulWidget {
  final String enquiryid;
  final String companyName;
  final String Enquirydescription;

  const receivedenquiriesdetailsviewscreen(
      {Key? key,
  ...
  @override
  State<receivedenquiriesdetailsviewscreen> createState() =>
      _receivedenquiriesdetailsviewscreen();
}

class _receivedenquiriesdetailsviewscreen
    extends State<receivedenquiriesdetailsviewscreen> {
  @override
  void initState() {
    super.initState();
