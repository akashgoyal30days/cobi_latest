...
class personaldocscreen extends StatefulWidget {
  personaldocscreen({Key? key}) : super(key: key);

  @override
  State<personaldocscreen> createState() => _personaldocscreenState();
}

class _personaldocscreenState extends State<personaldocscreen> with list {
  ...
  var abc;
  List docs = [];
  Future getpersonaldoclist() async {
    var abc = await getpersonaldocs();
    // debugPrint(abc.runtimeType.toString());
